 ...
 * });
 */
export function otpSchemaPlugin(schema, options) {
    ...
    schema.methods.generateOtp = function (length, otpOptions) {
        return generateOtp.call(this, length, otpOptions, options.saveIn === saveIn.REDIS ? options.email : undefined, options.saveIn === saveIn.REDIS ? options.redisClient : undefined);
    };
    /**
    ...
    schema.methods.verifyOtp = function (otp, context) {
        return verifyOtp.call(this, otp, context, options.saveIn === saveIn.REDIS ? options.email : undefined, options.saveIn === saveIn.REDIS ? options.redisClient : undefined);
    };
}
